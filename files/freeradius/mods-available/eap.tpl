...
#   }
    ...
    tls-config tls-common {
        ...
        private_key_password = SSL_PRIV_KEY_PASSWORD
        private_key_file = /etc/freeradius/certs/ad.lis.priv.key
        ...
        certificate_file = /etc/freeradius/certs/ad.lis.priv.crt
        ...
        ca_file = /etc/freeradius/certs/ad.lis.priv.ca.crt
